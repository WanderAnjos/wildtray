        ...
        <div className="h-full overflow-y-auto">
          {error && !loading && (
            <div className='flex flex-col justify-center items-center gap-1 p-3'>
              ...
              <div className='text-xl text-center'>Erro ao conectar com o banco!</div>
              <div className='mt-2 text-center text-sm'>verifique as informações e o uso da <span className='font-bold'>VPN</span> se necessário!</div>
            </div>
          )}
          ...
          {!loading && dataBases.map((item) => (
            ...
            >
              ...
              >
                ...
                <div>{item.checked && <CheckCircle weight='duotone' className='w-4 h-4' />}</div>
              </div>
            </motion.div>
          ))}
        </div>
